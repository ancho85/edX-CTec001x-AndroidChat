...
public class ContactListAdapter extends RecyclerView.Adapter<ContactListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_contact, parent, false); //este layout para butterknife
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, int position) {
        //permite asignar los valores
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        //esta inyección generó para el adapter arriba, pero lo muevo aquí abajo para el ViewHolder
        @Bind(R.id.imgAvatar)
